                                        ...
                                        <Box w="50%" bg="lightslategrey" borderRadius="100px" minHeight="800px">
                                            <Center>
                                                <Box w="60%" marginTop="100px">
                                                    ...
                                                    <Center>
                                                        <Button colorScheme='blue' margin='5px' pos='absolute' marginTop="200px"> <Link href="profile">Log In</Link></Button>
                                                    </Center>
                                                    <Center>
                                                        <Text marginTop="425px">Don't have an account?</Text>
                                                        <Button colorScheme='blue' margin='5px' pos='absolute' marginTop="500px"> <Link href="signup">Sign Up</Link></Button>
                                                    </Center>
                                                </Box>
                                            </Center>
                                        </Box>
